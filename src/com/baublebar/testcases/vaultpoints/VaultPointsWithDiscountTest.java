...
public class VaultPointsWithDiscountTest extends TestBase {
	...
	public void applyVaultPointWithDicountTest(Hashtable<String, String> data) throws Throwable {
		APPLICATION_LOGS.debug("Executing the VaultPointsWithDicountTest");
		if (!TestUtil.isExecutable("VaultPointsWithDiscountTest", xls) || data.get("Runmode").equals("N"))throw new SkipException("Skipping the test");
	...
	public Object[][] getVaultWithDiscountData() {
		return TestUtil.getData("VaultPointsWithDiscountTest", xls);
	}
