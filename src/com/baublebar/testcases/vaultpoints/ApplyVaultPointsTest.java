...
import com.saucelabs.saucerest.SauceREST;
	 ...
	 */
	public class ApplyVaultPointsTest extends TestBase {
		
		@Test(dataProvider = "getEarnVaultPointData")
		public void applyVaultPointTest(Hashtable<String, String> data) throws Throwable {
			...
			shoppingCartPage.applyVaultPoints(data.get("ProductName"));
