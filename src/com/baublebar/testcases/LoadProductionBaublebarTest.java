...
public class LoadProductionBaublebarTest extends TestBase{
		...
		public void initConfigurations(){
			...
			try {
				FileInputStream fs = new FileInputStream(System.getProperty("user.dir")+"/src/com/baublebar/config/config_production.properties");
				CONFIG.load(fs);
			} catch (Exception e) {
